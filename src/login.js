            ...
            <div className="col-md-6 p-0 text-start">
              <div className="card bg-dark">
                <div className="card-body px-4 py-5 text-white">
                  ...
                  <h4>How to play?</h4>
                  <p className="mb-0">
                    Login with Google OR Github and then create game which will
                    give you a unique game id. You can share this id to your
                    friends or family to play with them!!
                  </p>
                </div>
              </div>
            </div>
            <div className="col md-6 p-0">
              <div className="card">
                <div className="card-body px-4 py-5">
                  ...
                  <div className="row px-2 ms-1 mt-3 text-start">
                    ...
                    <div className="row px-2 ms-1 mt-1 text-start">
                        <div className="col mb-3">
                          <button
